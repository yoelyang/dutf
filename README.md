...
```
DUTF bytes length: 3744  
UTF8 bytes length: 4134

Other examples come from the corpus of UDHR translations at http://efele.net/udhr/. This is a collection of more than 500 translations of the Universal Declaration of Human Rights. This provides a comparison of the compression rates under different encodings DUTF and SCSU in the UDHR corpus: [udhr-compression-result.scv](./src/test/java/com/yaoyang/dutf/udhr-compression-result.scv). The encoding and decoding implementation of SCSU is sourced from https://www.unicode.org/Public/PROGRAMS/SCSU/.
