...
import com.yaoyang.dutf.scsu.Expand;
...
public class BenchmarkTest {
    ...
    @Benchmark
    public void SCSU() throws IllegalInputException, EndOfInputException {
        String data = DATA_MAP.get(language);
        Compress compress = new Compress();
        byte[] bytes = compress.compress(data);
        Expand expand = new Expand();
        String decodedValue = expand.expand(bytes);
        Assert.assertEquals(data, decodedValue);
    }
